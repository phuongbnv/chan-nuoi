                        ...
                        <div class="p-5">
                            ...
                            <form action="{{route('register')}}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input required name="phone" type="text" class="form-control form-control-user" id="exampleInputPhone"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required name="password_confirm" type="password" class="form-control form-control-user"
                                            id="password_confirm" placeholder="Nhập lại">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input value="{{$gioithieu}}" name="code" type="text" class="form-control form-control-user" id="exampleInputCode"
                                        placeholder="Mã mời">
                                </div>
